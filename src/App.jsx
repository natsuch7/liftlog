...
export default function App() {
  ...
  return (
    <div style={{fontFamily:"system-ui,-apple-system,sans-serif",background:C.bg,minHeight:"100vh",width:"100%",maxWidth:480,margin:"0 auto",color:C.text}}>
      ...
      {/* Bottom nav */}
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:480,background:"#000",borderTop:"1px solid #1a1a1a",display:"flex",zIndex:20}}>
        {NAV.map(({id,label,Icon})=>(
          <button key={id} onClick={()=>{
            ...
            style={{flex:1,padding:"10px 0 12px",background:"transparent",border:"none",cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",gap:4,transition:"all 0.15s"}}>
            <Icon size={18} color={screen===id?"#e63946":"#333"} strokeWidth={screen===id?2.5:1.5}/>
            <span style={{fontSize:9,fontWeight:700,color:screen===id?"#e63946":"#333",letterSpacing:0.5}}>{label}</span>
          </button>
        ))}
      </div>
      <InstallBanner />
