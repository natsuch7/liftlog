...
function PhaseCard({ num, label, weeks, intensity, children }) {
  const isLast = num === '03'
  return (
...
export default function BlockPeriodizationGuide() {
  return (
    ...
    >
      ...
      <PhaseCard num="01" label="蓄積期（Accumulation）" weeks="Week 1〜3" intensity="65–75%">
        この時期は比較的軽い重量で多くのセットをこなします。フォームを固め、筋肉への総負荷量を増やすフェーズです。ボリュームを積んで基礎を作ることが目的で、次のフェーズへの土台になります。
      </PhaseCard>
      <PhaseCard num="02" label="強化期（Intensification）" weeks="Week 4〜6" intensity="75–87%">
        蓄積期で積み上げた基礎の上に、より重い重量への適応を進めます。回数は減りますが、1セットの質が上がります。神経系を鍛え、重量に対する適応力を高めるフェーズです。
      </PhaseCard>
      <PhaseCard num="03" label="実現期（Realization）" weeks="Week 7〜9" intensity="87–100%">
