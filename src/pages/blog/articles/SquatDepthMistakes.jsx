...
function MisconceptionCard({ num, title, children }) {
  return (
...
export default function SquatDepthMistakes() {
  return (
    ...
    >
      ...
      <MisconceptionCard num="1" title="「浅い方が高重量を扱えるから効果的」">
      ...
      <MisconceptionCard num="2" title="「深いと膝が壊れる」">
      ...
      <MisconceptionCard num="3" title="「ハムストリングスはスクワットで鍛えられる」">
